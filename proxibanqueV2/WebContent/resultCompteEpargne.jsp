...
<body>
	...
	<%
		Client cl = (Client) session.getAttribute("cdao");
	%>

	<h3><%=cl.getNom() %>
		<%=cl.getPrenom() %></h3>

	<form action="resultCreaEpargne" method="post" accept-charset="UTF-8">
		...
		<br> Taux de rémunération <br>
		<div class="input-group">
			<div class="input-group-addon">%</div>
			<input type="text" name="tauxremun" value=3 class="form-control"
				id="exampleImputAmount">
			<div class="input-group-addon">.00</div>
		</div>
		<br> <input type="submit" value="Création du Compte Epargne"
			class="btn btn-info">
